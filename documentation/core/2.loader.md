...
- `development`: 本地开发环境，即 `ARTUS_SERVER_ENV=development` 时，将 `config.development.ts` 和 `config.default.ts` 进行 merge 操作
- `production`:  某种意义上的生产环境，即 `ARTUS_SERVER_ENV=production` 时，将 `config.production.ts` 和 `config.default.ts` 进行 merge 操作
